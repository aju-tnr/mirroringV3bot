...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, watch, shell, eval, torrent_search, delete, speedtest, usage, mediainfo, count, config, updates, anime, stickers, fun, animequotes, text, songs, waifu, nhentai, sitesearch, telegraph
