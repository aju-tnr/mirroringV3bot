import os
from bot.modules.fonts import Fonts
...
@app.on_message(filters.private & filters.incoming & filters.text & filters.command('kata'))
...
KATA_HANDLER = CommandHandler("kata", kata)

dispatcher.add_handler(KATA_HANDLER)